...
extension ColorProcessor {
    
    
    func run(input: CGImage, parameters: ColorParameters) throws -> MTLTexture {
        ...
        let kernelFunction = library.makeFunction(name: "colorize_rgb")
        ...
        commandEncoder?.setBytes(&params, length: MemoryLayout<ColorParameters>.stride, index: 0)
...
private extension ColorProcessor {
