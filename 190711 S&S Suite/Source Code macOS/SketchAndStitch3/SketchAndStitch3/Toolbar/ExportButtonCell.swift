...
class ExportButtonCell: NSButtonCell {
    
    var buttonTopColor: NSColor = NSColor.systemOrange.blended(withFraction: 0.2, of: NSColor.white)!
    var buttonBottomColor: NSColor = NSColor.systemOrange
